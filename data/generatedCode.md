...
```
//go:generate protoc -I=proto -I=$GOPATH/src -I=$GOPATH/src/github.com/DharitriOne/protobuf/protobuf  --gogoslick_out=. message.proto
```
...
Check [gogo protobuf geting started](https://github.com/DharitriOne/protobuf#getting-started) for initial setup.
