...
type PeerData struct {
	...
	ValueChange *math_big.Int `protobuf:"bytes,5,opt,name=ValueChange,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"valueChange,omitempty"`
}
...
type ShardData struct {
	...
	AccumulatedFees       *math_big.Int     `protobuf:"bytes,12,opt,name=AccumulatedFees,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"accumulatedFees,omitempty"`
	DeveloperFees         *math_big.Int     `protobuf:"bytes,14,opt,name=DeveloperFees,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"developerFees,omitempty"`
...
type Economics struct {
	TotalSupply                      *math_big.Int `protobuf:"bytes,1,opt,name=TotalSupply,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"totalSupply,omitempty"`
	TotalToDistribute                *math_big.Int `protobuf:"bytes,2,opt,name=TotalToDistribute,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"totalToDistribute,omitempty"`
	TotalNewlyMinted                 *math_big.Int `protobuf:"bytes,3,opt,name=TotalNewlyMinted,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"totalNewlyMinted,omitempty"`
	RewardsPerBlock                  *math_big.Int `protobuf:"bytes,4,opt,name=RewardsPerBlock,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"rewardsPerBlock,omitempty"`
	RewardsForProtocolSustainability *math_big.Int `protobuf:"bytes,5,opt,name=RewardsForProtocolSustainability,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"rewardsForProtocolSustainability,omitempty"`
	NodePrice                        *math_big.Int `protobuf:"bytes,6,opt,name=NodePrice,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"nodePrice,omitempty"`
...
type MetaBlock struct {
	...
	AccumulatedFees        *math_big.Int     `protobuf:"bytes,21,opt,name=AccumulatedFees,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"accumulatedFees,omitempty"`
	AccumulatedFeesInEpoch *math_big.Int     `protobuf:"bytes,22,opt,name=AccumulatedFeesInEpoch,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"accumulatedFeesInEpoch,omitempty"`
	DeveloperFees          *math_big.Int     `protobuf:"bytes,23,opt,name=DeveloperFees,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"developerFees,omitempty"`
	DevFeesInEpoch         *math_big.Int     `protobuf:"bytes,24,opt,name=DevFeesInEpoch,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"devFeesInEpoch,omitempty"`
