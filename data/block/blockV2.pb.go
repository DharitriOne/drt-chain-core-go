...
type HeaderV2 struct {
	...
	ScheduledAccumulatedFees *math_big.Int `protobuf:"bytes,3,opt,name=ScheduledAccumulatedFees,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"scheduledAccumulatedFees,omitempty"`
	ScheduledDeveloperFees   *math_big.Int `protobuf:"bytes,4,opt,name=ScheduledDeveloperFees,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"scheduledDeveloperFees,omitempty"`
