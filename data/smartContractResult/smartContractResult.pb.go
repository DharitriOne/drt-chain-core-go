...
import (
	...
	github_com_dharitrione_drt_chain_core_go_data_vm "github.com/DharitriOne/drt-chain-core-go/data/vm"
	io "io"
	math "math"
	math_big "math/big"
	math_bits "math/bits"
...
type SmartContractResult struct {
	...
	RelayedValue   *math_big.Int                                           `protobuf:"bytes,6,opt,name=RelayedValue,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"relayedValue"`
	...
	CallType       github_com_dharitrione_drt_chain_core_go_data_vm.CallType `protobuf:"varint,13,opt,name=CallType,proto3,casttype=github.com/DharitriOne/drt-chain-core-go/data/vm.CallType" json:"callType"`
...
func (m *SmartContractResult) GetCallType() github_com_dharitrione_drt_chain_core_go_data_vm.CallType {
	if m != nil {
		return m.CallType
	}
	return 0
	...
	for iNdEx < l {
		...
		case 13:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CallType |= github_com_dharitrione_drt_chain_core_go_data_vm.CallType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
