//go:generate protoc -I=. -I=$GOPATH/src/github.com/DharitriOne/drt-chain-core-go/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/DharitriOne/protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto
